package br.com.pedidofacil.ws.interceptors;
...
import br.com.pedidofacil.ws.repository.AuditoriaRepository;
...
public class AuditoriaRequestInterceptor extends GenericFilterBean {
	...
	private static final String EMPRESA_USUARIO = "idEmpresa";
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse response, FilterChain chain)
		...
		try {
    		...
    		empresa = req.getHeader(EMPRESA_USUARIO); if (empresa == null) empresa = "0";
            ...
            Auditoria auditoria = new Auditoria(Long.parseLong(empresa), usuario, operacao, 
